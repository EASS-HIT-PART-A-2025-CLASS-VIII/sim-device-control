...
function useLoadingSpinner(initial: LoadingSection = LoadingSection.None) {
...
async function readStatus(deviceUuid: string, setStatus: (status: string) => void, setLoading: (loading: LoadingSection) => void, setError: (error: string | null) => void) {
...
async function readVersion(deviceUuid: string, setVersion: (status: string) => void, setLoading: (loading: LoadingSection) => void, setError: (error: string | null) => void) {
    setLoading(LoadingSection.UsingDevice);
    setError(null);
    try {
        const response = await fetch(
